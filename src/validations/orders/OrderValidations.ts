...
export const orderUpdateValidationSchema = {
    [Segments.BODY]: Joi.object().keys({
        startDateTime: Joi.date()
            ...
            .min('now')
            .messages({
                'date.format': 'Start date must follow the format "(YYYY-MM-DDTHH:mm:ss)"',
        ...
        endDateTime: Joi.date()
            ...
            .messages({
                'date.format': 'End date must follow the format "(YYYY-MM-DDTHH:mm:ss)"',
        ...
        status: Joi.string()
            ...
            .optional()
            .messages({
                'any.only': 'Status must be one of "Aberto", "Aprovado", "Cancelado", or "Fechado"'
            })
